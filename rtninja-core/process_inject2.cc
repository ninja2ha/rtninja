...
static const ULONG32 ThreadProcShell32[] = {
  ...
  0x6A10468B, 0x1876FF00, 0x76FFD0FF, 0x14468B18, 0xC033D0FF, 0x5DE58B5E, 
  0xCC0004C2
};
...
static const ULONG64 ThreadProcShell64[] = {
  ...
  0x000002A08B8D4809, 0xD233304B8B48D0FF, 0xFF304B8B482053FF, 0x20C48348C0332853, 
  0xCCCCCCCCCCCCC35B
};
...
Process::InjectError Process::InjectLibraryByThreading(
  ...
  char msg[56];
  wsprintfA(msg, "p:%p", ThreadProcImpl);
