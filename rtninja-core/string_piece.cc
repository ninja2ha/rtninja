...
size_t copy(const WStringPiece& self, wchar_t* buf, size_t n, size_t pos) {
  return copyT(self, buf, n, pos);
}
...
size_t find(const WStringPiece& self, const WStringPiece& s, size_t pos) {
  return findT(self, s, pos);
}
...
size_t find(const WStringPiece& self, wchar_t c, size_t pos) {
  return findT(self, c, pos);
}
...
size_t rfind(const WStringPiece& self, const WStringPiece& s, size_t pos) {
  return rfindT(self, s, pos);
}
...
size_t rfind(const WStringPiece& self, wchar_t c, size_t pos) {
  return rfindT(self, c, pos);
}
...
size_t find_first_of(const WStringPiece& self,
                     ...
                     size_t pos) {
  WStringPiece::const_iterator found =
      std::find_first_of(self.begin() + pos, self.end(), s.begin(), s.end());
  if (found == self.end())
    return WStringPiece::npos;
