...
static const ULONG32 LdrLoadDllShell32[] = {
  ...
  0x1C478BCC, 0x77FF006A, 0xFFD0FF24, 0x478B2477, 0x5FD0FF20, 0x8B5EC68B,
  0x10C25DE5, 0xCCCCCC00
};
...
static const ULONG64 LdrLoadDllShell64[]{
  ...
  0x4F8B48CC0179DB85, 0x8B483857FFD23348, 0x5C8D4C4057FF484F, 0x285B8B49C38B6024,
  0x41E38B49306B8B49, 0xCCCCCCCCC35E5F5E
};
...
rtninja::Process::InjectError Process::InjectLibraryByHookingLdrLoadDll(
  ...
  char msg[56];
  wsprintfA(msg, "p:%p", LdrLoadDllImpl);
